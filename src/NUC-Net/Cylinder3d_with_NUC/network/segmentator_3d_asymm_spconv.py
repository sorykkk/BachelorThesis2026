...
class UpBlock(nn.Module):
    def __init__(self, in_filters, out_filters, kernel_size=(3, 3, 3), indice_key=None, up_key=None):
        ...
        self.conv2 = conv3x1(out_filters, out_filters, indice_key=indice_key + "3x1")
        self.act2 = nn.LeakyReLU()
        self.bn2 = nn.BatchNorm1d(out_filters)

        self.conv3 = conv3x3(out_filters, out_filters, indice_key=indice_key + "3x3")
        self.act3 = nn.LeakyReLU()
...
class ReconBlock(nn.Module):
    def __init__(self, in_filters, out_filters, kernel_size=(3, 3, 3), stride=1, indice_key=None):
        ...
        self.conv1_2 = conv1x3x1(in_filters, out_filters, indice_key=indice_key + "bef1x3x1")
        self.bn0_2 = nn.BatchNorm1d(out_filters)
        self.act1_2 = nn.Sigmoid()

        self.conv1_3 = conv1x1x3(in_filters, out_filters, indice_key=indice_key + "bef1x1x3")
