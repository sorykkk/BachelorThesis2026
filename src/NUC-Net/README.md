...
This repository includes a knowledge distillation pipeline that compresses the full NUC-Net teacher into a **50% smaller student** model (~75% FLOPs and parameter reduction) while minimizing the mIoU gap on SemanticKITTI.

Full details, training commands, and theoretical background: **[distillation/README.md](distillation/README.md)**
